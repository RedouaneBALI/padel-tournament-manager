...
/**
 * Groups/Poules phase handling - distributes teams into pools for round-robin play. Note: Consider migrating to AutomaticDrawStrategy or
 * ManualDrawStrategy for new implementations.
 */
@AllArgsConstructor
