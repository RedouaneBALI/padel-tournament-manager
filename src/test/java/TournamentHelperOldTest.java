...
import io.github.redouanebali.model.TournamentHelperOld;
...
public class TournamentHelperOldTest {
  ...
  public void testAffectPlayerPairsToRounds(
    ...
    List<Round> result = TournamentHelperOld.affectPlayerPairsToRounds(allPairs);
