...
const alpha3ToAlpha2: Record<string, string> = {
  ...
  CMR: 'CM', CAN: 'CA', CAF: 'CF', TCD: 'TD', CHL: 'CL', CHN: 'CN', COL: 'CO', COM: 'KM', COG: 'CG', CRI: 'CR',
  CIV: 'CI', HRV: 'HR', CUB: 'CU', CYP: 'CY', CZE: 'CZ', COD: 'CD', DNK: 'DK', DJI: 'DJ', DMA: 'DM', DOM: 'DO',
  ...
  VEN: 'VE', VNM: 'VN', YEM: 'YE', ZMB: 'ZM', ZWE: 'ZW', MAC: 'MO', UMI: 'UM'
}

export function getFlagEmoji(alpha3: string): string {
