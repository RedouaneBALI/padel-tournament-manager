...
const FACEBOOK_CLIENT_ID = defineSecret('FACEBOOK_CLIENT_ID');
const FACEBOOK_CLIENT_SECRET = defineSecret('FACEBOOK_CLIENT_SECRET');
...
exports.nextApp = onRequest(
  ...
  async (req, res) => {
    if (!prepared) {
      ...
      process.env.FACEBOOK_CLIENT_ID = FACEBOOK_CLIENT_ID.value();
      process.env.FACEBOOK_CLIENT_SECRET = FACEBOOK_CLIENT_SECRET.value();
